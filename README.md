...
## 🐾 프로필
- 🌱 배우고 있는 기술: **TypeScript**, **JavaScript**, **React**, **NestJS**
- 🛠️ 전문 기술: **웹 개발**, **앱 개발**
- 📫 연락: [이메일](mailto:simsim051128@gmail.com)
- 🎯 목표: 사용자 친화적인 웹과 앱을 개발하는 개발자
...
## 📂 주요 프로젝트
- **[배리어프리 앱](https://github.com/JangInChan/EarTalkNew)**: React Native를 활용한 모바일 접근성 중심 앱
  - Expo 및 Yarn을 활용한 배포
  - 접근성 강화 및 사용자 친화적 인터페이스 개발
